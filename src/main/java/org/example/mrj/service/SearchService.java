...
public class SearchService {
    ...
    public ResponseEntity<ApiResponse<List<Object>>> search(String searchTerm) {
        ...
        Specification<EquipmentCategory> equipmentCategorySpec = searchSpecification.equipmentCategoryContains(searchTerm);
        results.addAll(equipmentCategoryRepository.findAll(equipmentCategorySpec).stream()
